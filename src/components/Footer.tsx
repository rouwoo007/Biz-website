      ...
      <div className="container mx-auto py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <address className="not-italic flex flex-col gap-2 mt-1">
            ...
            >
              <svg className="w-4 h-4 mt-0.5 flex-shrink-0 text-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            >
              <svg className="w-4 h-4 flex-shrink-0 text-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="flex flex-col gap-1 mt-1">
            <span className="text-xs text-white/40">ABN: {company.abn}</span>
            <span className="text-xs text-white/40">QBCC Licence: {company.qbcc}</span>
          </div>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            {/* QBCC Licensed badge */}
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange/10 border border-orange/30 text-xs font-semibold text-orange">
